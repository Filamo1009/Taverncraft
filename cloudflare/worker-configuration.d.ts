/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dcbb3010546f13ffc6ea92bdbc453ae6)
...
interface __BaseEnv_Env {
	...
	R2_BUCKET_NAME: "taverncraft-data-staging" | "taverncraft-data-prod";
	R2_PREFIX: "staging" | "production";
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").LoginRateLimiter>;
	TAVERN: DurableObjectNamespace<import("./src/index").TavernContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LoginRateLimiter" | "TavernContainer";
	}
	interface StagingEnv {
		...
		ENVIRONMENT: "staging";
		CONTAINER_ENABLED: "true";
		R2_BUCKET_NAME: "taverncraft-data-staging";
		R2_PREFIX: "staging";
		RATE_LIMITER: DurableObjectNamespace<import("./src/index").LoginRateLimiter>;
		TAVERN: DurableObjectNamespace<import("./src/index").TavernContainer>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CONTAINER_ENABLED" | "R2_BUCKET_NAME" | "R2_PREFIX">> {}
}
