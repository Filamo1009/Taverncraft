...
## Что добавляет Taverncraft

Taverncraft — это форк SillyTavern с упором на более аккуратный API-дизайн и расширяемость.
...
- Документ по миграции API: [docs/luker-api-migration.md](https://github.com/Filamo1009/Taverncraft/blob/release/docs/luker-api-migration.md)
