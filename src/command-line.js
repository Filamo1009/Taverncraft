 ...
 * @property {boolean} listen If Taverncraft is listening on all network interfaces
 ...
 * @property {boolean} browserLaunchEnabled If automatically launch Taverncraft in the browser
    ...
    parse(args) {
        const cliArguments = yargs(hideBin(args))
            ...
            .option('browserLaunchEnabled', {
                type: 'boolean',
                default: null,
                describe: 'Automatically launch Taverncraft in the browser',
            })
