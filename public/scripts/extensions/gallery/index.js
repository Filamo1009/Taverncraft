...
function getGalleryFolder(char) {
    return Taverncraft.getContext().extensionSettings.gallery.folders[char?.avatar] ?? char?.name;
}
...
function getSortOrder() {
    return Taverncraft.getContext().extensionSettings.gallery.sort ?? defaultSettings.sort;
}
