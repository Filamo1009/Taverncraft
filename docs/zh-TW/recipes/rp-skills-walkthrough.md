...
難的是寫出一條真能改變輸出的 skill。Taverncraft 自帶二十多條作為起點——比如 `director-character-voice-zh`，規定每個角色（包括三無、android 這種冷感人設）首先都是有感官與本能的活的人，禁止情緒戲裡出現 "她注意到對方瞳孔散大" 這種觀察分析體；它預設就掛在導演 profile 裡，每次導演跑，所有 sub-agent 都看得到。
