...
感謝你對 Taverncraft 專案的關注！本文件介紹如何為 Taverncraft 貢獻程式碼、文件和其他改進。

## 開發環境準備

1. **Fork 倉庫**：在 GitHub 上 fork Taverncraft 倉庫到你的帳戶下。
...
Taverncraft 遵循 [Conventional Commits](https://www.conventionalcommits.org/) 規範：
