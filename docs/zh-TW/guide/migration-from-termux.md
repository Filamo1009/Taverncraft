...
如果你之前在 Termux 裡跑原版 SillyTavern，想換用 Taverncraft 的 Android APK，這篇指南說明如何把原有資料搬到 APK 中。Taverncraft 與 SillyTavern 資料格式完全相容，APK 在首次啟動時會彈出匯入精靈，正常情況下不需要碰 `Android/data` 私有目錄。
