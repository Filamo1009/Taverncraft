...
难的是写出一条真能改变输出的 skill。Taverncraft 自带二十多条作为起点——比如 `director-character-voice-zh`，规定每个角色（包括三无、android 这种冷感人设）首先都是有感官与本能的活的人，禁止情绪戏里出现 "她注意到对方瞳孔散大" 这种观察分析体；它默认就挂在导演 profile 里，每次导演跑，所有 sub-agent 都看得到。
