...
角色卡编辑助手（Character Editor Assistant，简称 CEA）是 Taverncraft 内置的 AI 辅助编辑工具。它让你可以用自然语言指令修改角色卡设定、世界书条目和 CardApp 代码，每次 AI 做出的修改都会以差异对比的形式展示，由你逐项审批后才会生效——确保角色卡始终在你的掌控之中。
