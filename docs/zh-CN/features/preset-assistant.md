...
补全预设助手（Completion Preset Assistant）是 Taverncraft 独有的 AI 辅助预设管理扩展。聊天补全 API 的预设包含大量参数（如 temperature、top_p、frequency_penalty 等），不同模型对这些参数的响应差异显著。补全预设助手通过对话式 AI 交互，帮助用户理解参数含义、对比预设差异，并提供调整建议。
