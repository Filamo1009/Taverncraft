...
感谢你对 Taverncraft 项目的关注！本文档介绍如何为 Taverncraft 贡献代码、文档和其他改进。

## 开发环境准备

1. **Fork 仓库**：在 GitHub 上 fork Taverncraft 仓库到你的账户下。
...
Taverncraft 遵循 [Conventional Commits](https://www.conventionalcommits.org/) 规范：
