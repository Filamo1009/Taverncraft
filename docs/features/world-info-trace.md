...
World Info Activation Trace is a debugging feature introduced by Taverncraft that helps you understand why a World Info entry was activated (or not activated).
