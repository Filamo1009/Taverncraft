...
Agenda's Planner dispatch is implemented via OpenAI tool calls and depends on Taverncraft's [Function Call Runtime](/improvements/function-call-runtime). That means:
